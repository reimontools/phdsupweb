...
const PersonUniversityCrud = ({user_id, person_id, fetch, personUniversity, isOpen, close}) => {
    // STATE ####################################################################################################################################
    ...
    const updatePersonUniversity = async data => {
        try {
            const res = await axios.post("person-university", {person_university_id: personUniversity.person_university_id, person_id, user_id, ...data});
